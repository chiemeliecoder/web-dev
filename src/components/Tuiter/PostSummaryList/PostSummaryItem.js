        ...
        <div className="wd-post-summary-item-wrapper">
            <li className="list-group-item">
                 <div className="mt-0">
                        ...
                        {post.topic != "" ? <span className="wd-selector fs-6">{post.topic}</span> : ""}
                        {post.userName != "" ? <strong>{post.userName}</strong>  : "" }<span className="wd-font-color wd-side2"><i className="fa-solid fa-certificate"></i></span>
                        <span className="wd-selector wd-font-size2 wd-side2">-{post.time}</span>
