...
const NavigationSidebar = (active) => {
  return(`
            ...
            <!-- continue the rest of the list -->
                <a href="home.html" class="list-group-item list-group-item-action ${active === "home" ? "active" : ""}"><i class="fa fa-house-user"></i><span class="d-none d-sm d-xl-inline-block">Home</span></a>
                <a href="#" class="list-group-item list-group-item-action ${active === "explorer" ? "active" : ""}"><i class="fa fa-hashtag"></i><span class="d-none d-sm d-xl-inline-block"> Explore</span></a>
